"""Memarket vendor connector (scrape based).
...
class MemarketVendor:
    name = "memarket"

    def __init__(self, base_url: str = "https://memarketaffiliate.com"):
        self.base_url = base_url

    async def fetch_products(self) -> List[VendorProduct]:
        pw, ctx = await launch_persistent(PWConfig(user_data_dir="./data/playwright/memarket", headless=True))
        try:
