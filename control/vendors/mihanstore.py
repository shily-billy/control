"""MihanStore vendor connector (scrape based).
...
class MihanStoreVendor:
    name = "mihanstore"

    def __init__(self, base_url: str = "https://mihanstore.net/partner"):
        self.base_url = base_url

    async def fetch_products(self) -> List[VendorProduct]:
        pw, ctx = await launch_persistent(PWConfig(user_data_dir="./data/playwright/mihanstore", headless=True))
        try:
